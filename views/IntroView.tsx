  ...
  return (
		<div className="min-h-screen bg-[#f3f0e9] relative overflow-hidden flex flex-col items-center justify-center py-8 px-6 font-display">
			...
			<div
				...
				style={{
					backgroundImage:
						"radial-gradient(#abced4 1px, transparent 0), linear-gradient(#eee 1px, transparent 1px)",
			...
			<div className="w-full max-w-4xl flex justify-between items-center mb-10 px-4 relative z-20 absolute top-8">
				...
				<div className="relative group cursor-pointer animate-pulse">
					<span className="material-symbols-outlined text-4xl text-primary drop-shadow-sm">
						card_giftcard
					</span>
				</div>
			</div>
			...
			<main className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-5xl gap-12">
				...
				<div className="relative w-full max-w-sm aspect-square flex items-center justify-center p-4 md:order-2">
					...
					<div className="absolute -top-4 -left-2 rotate-[-15deg] font-doodle text-primary text-4xl">
						♥
					</div>
					<div className="absolute top-2 right-4 bg-tape-pink px-4 py-1 -rotate-12 text-white font-handwritten text-sm shadow-sm">
						14 Januari 2001
					</div>
				...
				<div className="text-center md:text-left md:order-1 flex flex-col items-center md:items-start">
					<div className="space-y-2">
						...
						<h1 className="font-serif text-5xl md:text-7xl tracking-tighter text-gray-900 italic max-w-lg leading-tight">
							...
							<span className="text-primary font-display not-italic text-5xl md:text-7xl">
								!
							</span>
						</h1>
